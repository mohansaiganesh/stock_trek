...
var api_key = "cnba3m1r01qks5iv9u20cnba3m1r01qks5iv9u2g";

var polygon_api_key = "1hHsr88GZbU0dmSZxz8UIUWBwR6Wp0LQ"

var simulateMarket = false; //change later aif you want to simulate

function simulateMarketData(simulateMarket, data) {

  let updatedData = data;

  if (simulateMarket === true) {

    const currentTimestamp = Math.floor(Date.now() / 1000);

    let lastTwoDigits = currentTimestamp % 13;

    updatedData.t = currentTimestamp;
    updatedData.c = updatedData.c + lastTwoDigits;
...
const CONNECTION_STRING = "mongodb+srv://mkanna:1234@cluster0.ktpds8z.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
const DATABASE_NAME = "stockNew";
...
app.get("/quote", async (req, res) => {
  ...
  try {
    ...
    data = simulateMarketData(simulateMarket, data);

    console.log("data in quote ", data);
